...
![image1](https://feohorg.files.wordpress.com/2017/10/img_0066.jpg)

A while ago I wrote a [post](https://feoh.org/2017/03/04/apple-ipad-pro-smart-keyboard/) about the then new Apple iPad Pro with its awesome keyboard.
...
They’ve also added the ability to drag and drop files between applications! Finally I can write a document using my favorite editor - [Editorial](https://omz-software.com/editorial/), and check it into source control using [Working Copy](https://workingcopyapp.com).
